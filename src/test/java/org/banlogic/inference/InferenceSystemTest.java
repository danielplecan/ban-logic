...
public class InferenceSystemTest {
    ...
    private InferenceRule inferMessageMeaningForPublicKeys = new InferMessageMeaningForPublicKeys();
    private InferenceRule inferMessageMeaningForSharedKeys = new InferMessageMeaningForSharedKeys();
