...
public class InferComponentsForSelfPublicKeys implements InferenceRule {

    @Override
    public List<String> apply(String firstFormula, String secondFormula) {
        String firstPatternValue = "^" + NAME_GROUP + BELIEVES_PATTERN + String.format(PK_PATTERN, "\\1", NAME_GROUP);
        ...
        String key = firstMatcher.group(2);
